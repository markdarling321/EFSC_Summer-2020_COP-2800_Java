...
public class DrawLines2 extends Application
{ 
	@Override 
	...
	{ 
		...
		Parent root = 
		FXMLLoader.load(getClass().getResource("DrawLines2.fxml" )); 

		Scene scene = new Scene(root); // attach scene graph to scene 
		stage.setTitle("Draw Lines2"); // displayed in window's title bar 
