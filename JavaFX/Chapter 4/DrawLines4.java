...
public class DrawLines4 extends Application
{ 
	@Override 
	...
	{ 
		...
		Parent root = 
		FXMLLoader.load(getClass().getResource("DrawLines4.fxml" )); 

		Scene scene = new Scene(root); // attach scene graph to scene 
		stage.setTitle("Draw Lines4"); // displayed in window's title bar 
