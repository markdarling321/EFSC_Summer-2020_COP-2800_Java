...
public class DrawLines1 extends Application
{ 
	@Override 
	...
	{ 
		...
		Parent root = 
		FXMLLoader.load(getClass().getResource("DrawLines1.fxml" )); 

		Scene scene = new Scene(root); // attach scene graph to scene 
		stage.setTitle("Draw Lines1"); // displayed in window's title bar 
