...
public class DrawLines3 extends Application
{ 
	@Override 
	...
	{ 
		...
		Parent root = 
		FXMLLoader.load(getClass().getResource("DrawLines3.fxml" )); 

		Scene scene = new Scene(root); // attach scene graph to scene 
		stage.setTitle("Draw Lines3"); // displayed in window's title bar 
