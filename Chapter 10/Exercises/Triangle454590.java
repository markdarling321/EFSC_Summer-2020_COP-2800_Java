...
public class Triangle454590 extends RightTriangle
{
	// private int edges;
	// private int faces;
	...
	// DEFAULT CONSTRUCTOR
	public Triangle454590()
	{
		super();
		this.parent = "Shape > Shape2D > Polygon > Triangle > RightTriangle";
		this.note = "45-45-90 triangle";
	}

	// 2 VARIABLE CONSTRUCTOR
	public Triangle454590(double base, double height)
	{
		super(base, height);
		this.parent = "Shape > Shape2D > Polygon > Triangle > RightTriangle";
		this.note = "45-45-90 triangle";
	...
	public Triangle454590(double side1, double side2, double side3)
	{
	...
	public void declare()
	{
		System.out.println("public class Triangle454590 extends RightTriangle");
		// super.declare();
