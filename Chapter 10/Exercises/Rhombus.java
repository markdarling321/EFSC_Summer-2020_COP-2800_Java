...
//	private String note;
	...
	public Rhombus()
	{
		...
		this.note = "an equilateral quadrilateral";
	}

	// 1 VARIABLE CONSTRUCTOR (a square)
	public Rhombus(double edge)
	{
		super(edge);
		this.parent = "Shape > Shape2D > Polygon > Quadrilateral > Parallelogram";
		this.note = "an equilateral quadrilateral";
	...
	public Rhombus(double edgePair1, double edgePair2)
	{
	...
	public Rhombus(double edge1, double edge2, double edge3, double edge4)
	{
	...
	public void declare()
	{
		System.out.println("public class Rhombus extends Parallelogram");
		// super.declare();
