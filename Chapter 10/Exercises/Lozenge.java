...
public class Lozenge extends Rhombus
{
//	private int edges;
//	private int faces;
...
//	private String note;
	...
	{
		super();
		this.parent = "Shape > Shape2D > Polygon > Quadrilateral > Parallelogram > Rhombus";
		this.note = "AKA: diamond";
	}

	// 1 VARIABLE CONSTRUCTOR (a square)
	public Lozenge(double edge)
	{
		super(edge);
		this.parent = "Shape > Shape2D > Polygon > Quadrilateral > Parallelogram > Rhombus";
		this.note = "AKA: diamond";
	...
	public Lozenge(double edgePair1, double edgePair2)
	{
	...
	public Lozenge(double edge1, double edge2, double edge3, double edge4)
	{
	...
	public void declare()
	{
		System.out.println("public class Lozenge extends Rhombus");
		//super.declare();
